...
class Id4meConstants {
  static final String CONTENT_TYPE = 'Content-Type';
  static final String AUTHORIZATION = 'Authorization';

  static String KEY_CLIENT_NAME = 'clientName';
  static String KEY_REDIRECT_URI = 'redirectURI';
  static String KEY_REDIRECT_URIS = 'redirectURIs';
  static String KEY_LOGO_URI = 'logoURI';
  static String KEY_DNS_ROOT_KEY = 'dnssecRootKey';
  static String KEY_REGISTRATION_DATA_PATH = 'registrationDataPath';
  static String KEY_DNS_RESOLVER = 'dnsResolver';
